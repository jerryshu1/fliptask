...
<!--  <el-button v-if="this.usermessage.role === 'superadmin'" @click="superadmindeletetask" style="margin-left: 350px">删除任务</el-button>-->
  <el-button v-if="this.usermessage.role === 'admin'" @click="admindeletetask"  style="margin-left: 49%">删除任务</el-button>
  ...
  methods: {
    ...
    admindeletetask(){
      for (var i in this.selected){
        deletetask(this.usermessage.company_id, this.selected[i].id, this.token)
      }
      setTimeout(()=>{
